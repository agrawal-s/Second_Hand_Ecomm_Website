...
--CATEGORY ID
ALTER TABLE T_ITEM ADD CONSTRAINT FK_T_ITEM_CATEGORY_ID FOREIGN KEY(FK_I_CATEGORY_ID) REFERENCES T_CATEGORY(PK_I_ID);
ALTER TABLE T_KEYWORDS ADD CONSTRAINT FK_T_KEYWORDS_CATEGORY_ID FOREIGN KEY(FK_I_CATEGORY_ID) REFERENCES T_CATEGORY(PK_I_ID);
ALTER TABLE T_PLUGIN_CATEGORY ADD CONSTRAINT FK_T_PLUGIN_CATEGORY_CATEGORY_ID FOREIGN KEY(FK_I_CATEGORY_ID) REFERENCES T_CATEGORY(PK_I_ID);
ALTER TABLE T_CATEGORY_STATS ADD CONSTRAINT FK_T_CATEGORY_STATS_CATEGORY_ID FOREIGN KEY(FK_I_CATEGORY_ID) REFERENCES T_CATEGORY(PK_I_ID);
ALTER TABLE T_CATEGORY_DESCRIPTION ADD CONSTRAINT T_CATEGORY_DESCRIPTION_CATEGORY_ID FOREIGN KEY(FK_I_CATEGORY_ID) REFERENCES T_CATEGORY(PK_I_ID);
ALTER TABLE T_META_CATEGORIES ADD CONSTRAINT FK_T_META_CATEGORIES_CATEGORY_ID FOREIGN KEY(FK_I_CATEGORY_ID) REFERENCES T_CATEGORY(PK_I_ID);
ALTER TABLE T_CATEGORY ADD CONSTRAINT FK_T_CATEGORY_CATEGORY_ID FOREIGN KEY(FK_I_PARENT_ID) REFERENCES T_CATEGORY(PK_I_ID);
